...
html{width:100%;max-width:100%;min-width:0;overflow-x:clip;scroll-behavior:smooth}
body{width:100%;max-width:100%;min-width:0;margin:0;padding:0;overflow-x:clip;background-color:var(--bb-bg);color:var(--bb-text);font-family:var(--bb-font-body);-webkit-text-size-adjust:100%}
button,input,select,textarea{font:inherit}
button,a,input,select,textarea{-webkit-tap-highlight-color:transparent}
#app{display:flex;flex-direction:column;align-items:center;width:100%;max-width:100%;min-height:100vh;min-width:0;overflow-x:clip}
.bb-header{position:sticky;top:0;z-index:40;display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:1rem;width:100%;max-width:100%;padding:12px max(18px,env(safe-area-inset-right)) 12px max(18px,env(safe-area-inset-left));border-bottom:1px solid var(--bb-border);background:color-mix(in srgb,var(--bb-bg) 90%,transparent);backdrop-filter:blur(10px)}
...
.bb-nav{display:flex;justify-content:center;gap:.35rem;min-width:0;max-width:100%}

<template>
  <section class="admin-shell">
    ...
    <template v-else>
      <div class="tabs-hint" aria-hidden="true">Swipe admin sections <span>→</span></div>
      ...
      <section v-if="activeTab === 'products'" class="products-section">
        <div class="creation-card">
          <header class="creation-heading">
            ...
            <div v-if="!productForm._id" class="mode-toggle" role="group" aria-label="Product creation method">

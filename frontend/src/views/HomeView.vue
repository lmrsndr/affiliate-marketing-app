...
<style scoped>
.shop-home{display:block;width:100%;max-width:100%;min-width:0;margin:0 auto;padding:1.5rem 1rem 4rem;color:var(--bb-text);overflow-x:clip}
.shop-home>*{width:100%;max-width:100%;min-width:0}
.hero{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(0,.75fr);gap:2rem;padding:clamp(2rem,5vw,4.5rem);border:1px solid var(--bb-border);border-radius:28px;background:linear-gradient(135deg,var(--bb-surface),color-mix(in srgb,var(--bb-primary-light) 12%,var(--bb-surface)));overflow:hidden}
.hero-copy,.promise{min-width:0}
...
@media(max-width:900px){.hero{grid-template-columns:1fr}.product-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.steps{grid-template-columns:1fr}.filters{grid-template-columns:1fr 1fr}.filters input{grid-column:1/-1}.guided-search{grid-template-columns:1fr}}
@media(max-width:640px){
 .shop-home{padding:.45rem 0 3rem}
 .hero{gap:1rem;padding:1.2rem;border-radius:20px}h1{font-size:clamp(2.1rem,11vw,3rem);line-height:1;margin:.35rem 0 .8rem}.hero-text{font-size:1rem;line-height:1.5}.hero-actions{display:grid;grid-template-columns:1fr;gap:.55rem;margin-top:1rem}.hero-actions .btn{width:100%;text-align:center;padding:.72rem .65rem;font-size:.9rem}.promise{padding:1rem;border-radius:16px}.promise>span{font-size:1.5rem}.promise h2{font-size:1.15rem;margin:.35rem 0}.promise p{font-size:.9rem;line-height:1.45;margin:.2rem 0}
 .discovery-section,.guided-search,.catalogue,.how-it-works{margin-top:2.5rem}.section-heading{padding:0 .15rem}.section-heading h2,.catalogue-heading h2{font-size:1.85rem;line-height:1.08}.section-heading>p{font-size:.92rem;line-height:1.45}.carousel-hint{display:flex;justify-content:flex-end;gap:.35rem;align-items:center;margin:.7rem .15rem -.2rem;color:var(--bb-muted);font-size:.78rem}.carousel-hint span{font-size:1.1rem}
 .idea-grid{display:flex;width:100%;max-width:100%;overflow-x:auto;overflow-y:hidden;gap:.75rem;margin:1rem 0 0;padding:0 .15rem .75rem;scroll-snap-type:x mandatory;scroll-padding-inline:.15rem;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch;scrollbar-width:none}.idea-grid::-webkit-scrollbar{display:none}.idea-card{flex:0 0 calc(100% - 2.2rem);max-width:300px;min-height:150px;padding:1rem;border-radius:18px;scroll-snap-align:start}.idea-card>span{font-size:1.4rem}.idea-card strong{font-size:1.05rem}.idea-card small{font-size:.88rem}
 .guided-search{display:block;padding:1rem;border-radius:20px;overflow:hidden}.guided-block+.guided-block{margin-top:1.35rem;padding-top:1.25rem;border-top:1px solid var(--bb-border)}.guided-search h2{font-size:1.5rem;margin:.2rem 0 .7rem}.chips{display:flex;width:100%;max-width:100%;flex-wrap:nowrap;overflow-x:auto;overflow-y:hidden;gap:.5rem;margin:0;padding:.15rem 0 .55rem;scroll-snap-type:x proximity;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch;scrollbar-width:none}.chips::-webkit-scrollbar{display:none}.chips button{flex:0 0 auto;scroll-snap-align:start;padding:.55rem .75rem;font-size:.85rem}
 .catalogue-heading{align-items:flex-start}.catalogue-heading>span{font-size:.82rem;white-space:nowrap;margin-top:.45rem}.filters{grid-template-columns:1fr;gap:.55rem}.filters input{grid-column:auto}.clear{width:100%}.state{padding:1.4rem 1rem}.product-grid{grid-template-columns:1fr}.product-footer{align-items:stretch;flex-direction:column}.product-footer .btn{width:100%}.steps{gap:.75rem}.steps article{padding:1rem}
}
</style>

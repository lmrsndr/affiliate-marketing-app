...
// New shopping-platform API. These routes sit alongside the legacy
// subscription-box endpoints while the catalogue and existing data migrate.
router.use(require("./shoppingRoutes"));

// Legacy: Get Top Categories Based on Popularity (Authenticated Users Only)
